...
To address these questions, I’ve been developing interpretability methods ([RSVC](https://nkondapa.github.io/rsvc-page/) (ICLR 2025), [RDX](https://nkondapa.github.io/rdx-page/) (NeurIPS 2025)) to analyze these similarities and differences across representations. Comparison is a powerful lens for understanding how changes in training, architecture, or data shape the representations models learn. Looking ahead, I want to extend this work to compare human and model representations, uncovering concepts unique to each. This knowledge will help improve the alignment between how machines and humans represent the world, enabling the development of safer and more interpretable models.
